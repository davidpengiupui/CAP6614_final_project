...
def tensor_clip_0(x):
    return x[:, 1:75, 1:75]
def tensor_clip_1(x):
    return x[:, 1:75, 75:149]
def tensor_clip_2(x):
    return x[:, 1:75, 149:223]
def tensor_clip_3(x):
    return x[:, 75:149, 1:75]
def tensor_clip_4(x):
    return x[:, 75:149, 149:223]
def tensor_clip_5(x):
    return x[:, 149:223, 1:75]
def tensor_clip_6(x):
    return x[:, 149:223, 75:149]
def tensor_clip_7(x):
    return x[:, 149:223, 149:223]
...
def rotate_single_with_label(img, label):
    if label == 0:
        ...
        img = tensor_clip_0(img)
    elif label == 1:
        img = tensor_clip_1(img)
    elif label == 2:
        img = tensor_clip_2(img)
    elif label == 3:
        img = tensor_clip_3(img)
    elif label == 4:
        img = tensor_clip_4(img)
    elif label == 5:
        img = tensor_clip_5(img)
    elif label == 6:
        img = tensor_clip_6(img)
    elif label == 7:
        img = tensor_clip_7(img)
...
def train_target_rot(args):
    ...
    netR = feat_classifier(type='linear', class_num=8, bottleneck_dim=2*args.bottleneck).cuda()
    ...
    max_iter = args.max_epoch * len(dset_loaders["target"]) * 3
    ...
    while iter_num < max_iter:
        ...
        f_outputs = netB(netF(inputs_test[:, :, 75:149, 75:149]))
...
def train_target(args):
    ...
    max_iter = args.max_epoch * len(dset_loaders["target"])*2
